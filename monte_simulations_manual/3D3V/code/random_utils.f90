!===============================================================================
! Module: random_utils
! xoshiro256+ random number generator, Maxwell distribution sampling
! Thread-safe: each particle has its own RNG state
!===============================================================================
module random_utils
...
contains
   ...
   !---------------------------------------------------------------------------
   ! xoshiro256+ inside helper: 64bit rotate
   !---------------------------------------------------------------------------
   ...
   !---------------------------------------------------------------------------
   ! xoshiro256+: [0,1) double precision uniform random number
   ...
   function random_double(rng) result(r)
      ...
      ! convert to [0,1) double precision uniform random number
      ! use upper 53 bits
   ...
   !---------------------------------------------------------------------------
   ! Initialize RNG state using SplitMix64
   ! seed: initial seed
   ! rng: output RNG state
   !---------------------------------------------------------------------------
   ...
   !---------------------------------------------------------------------------
   ! Initialize traditional random seed (for non-parallel initialization only)
   !---------------------------------------------------------------------------
   ...
   !---------------------------------------------------------------------------
   ! Sample Maxwell velocity distribution using Box-Muller method
   ! rng: particle-specific RNG state
   !---------------------------------------------------------------------------
   ...
   !---------------------------------------------------------------------------
   ! Sample Maxwell velocity distribution for ions with flow velocity offset
   ! rng: particle-specific RNG state
   !---------------------------------------------------------------------------
   ...
   !---------------------------------------------------------------------------
   ! Set beam velocity for a single direction
   !---------------------------------------------------------------------------
