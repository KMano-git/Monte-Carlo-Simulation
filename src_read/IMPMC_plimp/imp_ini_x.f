...
!**********************************************************************
     ...
     >    , stcpy, ufl6
      use mod_shexe, only : impmc_model, INP_IMP, use_namelist
      implicit none
!
!::arguments
...
!::clear /cimden/
      ...
      enddo
!
!::KSFUJI  wrad in plprof (imp_pls)
!      wrad(1:ndx,1:ndy) = 0.0d0
!
...
!
!xx      i60_tmwgtn = 0   ! under development
!
