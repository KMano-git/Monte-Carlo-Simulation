...
!
!-----------------------------------
!::Lz(Te) of Ne rlos=1e-16, ne=1e20, n0/ne=0 
      zx = zte
      zx = dmin1(zx,1.0d4)
      zx = dmax1(zx,1.0d0)
      zx = dlog10(zx)
      zy = -39.156d0 + 14.508d0 *zx    - 10.99d0   *zx**2
     >               + 4.5983d0 *zx**3 - 1.1487d0  *zx**4
     >               + 0.16104d0*zx**5 - 0.009639d0*zx**6
      zlz = 10.0d0**zy
!
